...
import {
    Sparkles, BadgeCheck, Cloud, GraduationCap, Users, Target,
    ArrowUpRight, Cpu, Database, BarChart3, Brain, Server, 
} from 'lucide-react'
...
function IBMMark({ size = 32 }: { size?: number }) {
    return (
        <svg viewBox="0 0 64 28" width={size * (64 / 28)} height={size} aria-label="IBM" role="img">
            ...
            <text x="0" y="22" fontFamily="Inter, system-ui, sans-serif" fontWeight={800} fontSize="14" letterSpacing="2" fill="currentColor">IBM</text>
        </svg>
    )
}
    ...
    return (
        <section
            ...
            <div aria-hidden="true" className="absolute pointer-events-none"
                style={{ top: -160, left: -80, width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle, rgba(5,48,173,0.07) 0%, transparent 65%)', filter: 'blur(80px)' }} />
            <div aria-hidden="true" className="absolute pointer-events-none"
                style={{ bottom: -160, right: -80, width: 640, height: 640, borderRadius: '50%', background: 'radial-gradient(circle, rgba(0,120,212,0.09) 0%, transparent 65%)', filter: 'blur(80px)' }} />
            ...
            <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
                ...
                <motion.div
                    ...
                    <h2 style={{
                        ...
                        Built with{' '}
                        <span style={{ fontWeight: 800, color: '#0530AD' }}>IBM</span>.{' '}
                    ...
                    <p style={{ fontSize: 16, lineHeight: 1.75, color: 'var(--text-secondary)', marginBottom: 32 }}>
                        ...
                        Every flagship cohort earns a co-branded credential plus cloud credits to prove it on real work.
                    </p>
                    ...
                    <div style={{
                        ...
                        <span style={{ color: '#0530AD' }}><IBMMark size={22} /></span>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(480px, 1fr))', gap: 24, marginBottom: 24 }}>
                    ...
                    <PartnerPanel
                        ...
                        partner="IBM"
                        partnerLogo={<span style={{ color: '#0530AD' }}><IBMMark size={26} /></span>}
                ...
                <motion.div
                    ...
                    {[
                        ...
                        <span key={label} style={{ display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 13, fontWeight: 600, color: 'var(--text-secondary)' }}>
...
function PartnerPanel({
    accent, accentSoft, accentMid, eyebrow, partner, partnerLogo,
    headline, headlineItalic, why, whoBody, steps, programs, stats,
    ...
    return (
        <motion.div
            ...
            <div style={{
                ...
                {/* WHY */}
                <ContentBlock number="01" label="Why it matters" accent={accent} accentSoft={accentSoft}>
                ...
                {/* WHO + programs */}
                <ContentBlock number="02" label="Who it is for" accent={accent} accentSoft={accentSoft}>
                ...
                {/* HOW */}
                <ContentBlock number="03" label="How you get certified" accent={accent} accentSoft={accentSoft}>
                        ...
                        {steps.map((s, i) => (
                            <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                                <span style={{
                                    ...
                                    display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
                                    background: accentMid, color: accent,
                ...
                <div style={{
                    ...
                    gap: 8, paddingTop: 20, marginTop: 4,
                    ...
                    {stats.map((s) => (
                        <div key={s.l} style={{
                            ...
                            <div style={{
                                ...
                                color: accent, fontFamily: 'var(--font-display, inherit)',
                            }}>
                                {s.v}
                            </div>
                            <div style={{
            ...
            <div style={{
                ...
                <button
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-1px)'; (e.currentTarget as HTMLButtonElement).style.boxShadow = `0 10px 28px ${accent}55` }}
                    onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.transform = ''; (e.currentTarget as HTMLButtonElement).style.boxShadow = `0 6px 20px ${accent}45` }}>
...
function ContentBlock({
    number, label, accent, accentSoft, children,
}: {
    number: string
    label: string
    accent: string
