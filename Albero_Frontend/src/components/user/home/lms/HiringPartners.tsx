    ...
    return (
        <div
            ...
            style={{
                ...
                height: 92,
                borderRadius: 18,
                background: hovered ? `linear-gradient(135deg, ${p.color}18 0%, ${p.color}08 100%)` : 'var(--surface)',
...
const MarqueeRow = memo(function MarqueeRow({ items, reverse = false, duration = 55 }: { items: Partner[]; reverse?: boolean; duration?: number }) {
                    ...
                    <div className="grid md:grid-cols-[1fr_360px] gap-12 items-end mb-14">
                        ...
                        <motion.div
                            ...
                            <p
                                ...
                                Active hiring relationships with 180+ teams across product, BFSI, consulting, and big tech. Mentor referrals route
                                directly into hiring-manager inboxes.
                            </p>
                            <a
                                href="#"
