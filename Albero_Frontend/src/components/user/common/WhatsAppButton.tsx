...
export default function WhatsAppButton() {
    ...
    const ask = (faq: Faq) => {
        ...
        window.setTimeout(() => {
            setMessages((prev) => [...prev, { id: nextId(), sender: 'bot', text: faq.a, cta: faq.cta }])
            setThinking(false)
                ...
                <div
                    ...
                    <div
                        ...
                        <div className="flex-1 min-w-0 leading-tight">
                            ...
                            <div className="text-[11.5px] opacity-80">Albero assistant · replies in seconds</div>
                        </div>
                        <button
                    ...
                    <div
                        ...
                        style={{
                            background: 'repeating-linear-gradient(45deg, var(--surface-2) 0 1px, transparent 1px 14px), var(--surface-2)'
                        }}>
                        {messages.map((m) => (
                            <Bubble
                                key={m.id}
                        ...
                        {thinking && (
                            <div className="flex items-end gap-2 alb-chat-msg-in">
                                ...
                                <div
                                    ...
                                    <span
                                        className="alb-chat-dot"
                                        style={{ background: 'var(--brand)', animationDelay: '0s' }}
                                    />
                                    <span
                                        className="alb-chat-dot"
                                        style={{ background: 'var(--brand)', animationDelay: '0.18s' }}
                                    />
                                    <span
                                        className="alb-chat-dot"
                                        style={{ background: 'var(--brand)', animationDelay: '0.36s' }}
                                    />
                                </div>
                            </div>
                        )}
...
function Albi({ state, size }: { state: 'happy' | 'thinking'; size: number }) {
    ...
    const animation = isThinking ? 'alb-thinking-bob 1.4s ease-in-out infinite' : 'alb-bob 3.2s ease-in-out infinite'
    return (
        <div
            aria-hidden="true"
