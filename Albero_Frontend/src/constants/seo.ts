...
export const aboutSEO: SEOData = {
    ...
    keywords: 'about Albero Academy, mentors, founders, story, learning platform, career training, Noida edtech',
    url: `${SITE_URL}/about`,
...
export const workSEO: SEOData = {
    ...
    keywords: 'Albero Academy case studies, learner outcomes, placements, salary jumps, capstone projects, success stories',
    url: `${SITE_URL}/work`,
...
export const pricingSEO: SEOData = {
    ...
    keywords: 'Albero Academy pricing, course fees, EMI options, mentor-led plans, career pro plan, learning plans India',
...
export const contactSEO: SEOData = {
    ...
    keywords: 'contact Albero Academy, counsellor, support, admissions, free demo, cohort intro',
...
export const programSEO: Record<string, SEOData> = {
    'business-analytics': {
        ...
        keywords: 'business analytics course, Excel SQL Power BI training, business analyst program India, Albero Academy',
    ...
    'data-analytics': {
        ...
        keywords: 'data analytics course, data analyst training, SQL Python Power BI, Albero Academy, job-ready analytics',
    ...
    'data-science-ai': {
        ...
        keywords: 'data science course, machine learning training, generative AI course, LLMs, Albero Academy AI program',
    ...
    'full-stack': {
        ...
        keywords: 'full stack developer course, MERN stack training, React Node.js MongoDB, Albero Academy engineering program',
    ...
    'data-engineering': {
        ...
        keywords: 'data engineering course, Spark Airflow dbt training, Kafka streaming, Snowflake course, Albero Academy',
    ...
    cybersecurity: {
        ...
        keywords: 'cybersecurity course, ethical hacking training, SOC analyst program, OWASP Top 10, penetration testing, Albero Academy',
    ...
    'investment-banking': {
        ...
        keywords: 'investment banking course, financial modelling training, M&A LBO course, pitchbook training, IB analyst, Albero Academy',
    ...
    'product-analytics': {
        ...
        description: '4-month Product Analytics program — funnels, retention, A/B testing, and PM-style thinking with Mixpanel, Amplitude & GA4.',
        keywords: 'product analytics course, A/B testing training, Mixpanel Amplitude, growth analyst program, Albero Academy',
...
export const blogsHubSEO: SEOData = {
    ...
    keywords: 'data analytics blog, AI blog, software engineering articles, career advice India, Albero Academy resources',
...
export const tutorialsHubSEO: SEOData = {
    ...
    keywords: 'free Python tutorials, free SQL tutorials, Power BI tutorial, Tableau tutorial, statistics tutorials, Albero Academy',
...
export const softSkillsHubSEO: SEOData = {
    ...
    keywords: 'soft skills for engineers, tech career communication, LinkedIn optimisation, interview prep, Albero Academy',
...
export const caseStudiesHubSEO: SEOData = {
    ...
    keywords: 'business case studies, strategy case studies, business model analysis, MBA case studies, Albero Academy',
...
export const interviewGuidesHubSEO: SEOData = {
    ...
    keywords: 'Python interview questions, SQL interview prep, Excel interview, Power BI interview, statistics interview, Albero Academy',
...
export const cheatSheetsHubSEO: SEOData = {
    ...
    keywords: 'Python cheat sheet, SQL cheat sheet, DAX cheat sheet, statistics cheat sheet, ML cheat sheet, Albero Academy',
...
export const privacySEO: SEOData = {
    ...
    keywords: 'Albero Academy privacy policy, data protection, cookies, GDPR, DPDP Act India',
...
export const escalationSEO: SEOData = {
    ...
    description: 'How to escalate concerns at Albero Academy — Level 1 to Level 3 contact paths, response SLAs, and grievance officer details.',
    keywords: 'Albero Academy escalation, grievance redressal, learner support escalation',
...
export const examinationSEO: SEOData = {
    ...
    description: "Albero Academy's examination, evaluation, and certification policy — attempt limits, retake fees, integrity rules, and grading.",
    keywords: 'Albero Academy examination policy, course evaluation, certification rules, retake policy',
...
export function buildTutorialChapterSEO(args: { topic: string; chapter: string; title: string; description: string; keywords?: string }): SEOData {
