...
import { assignManagerSchema, createTaskSchema, reportRangeSchema, taskListQuerySchema, updateTaskSchema } from './counsellor-management.schema'
...
router.get('/reports/me', requirePolicy('counsellor_report', 'read'), validate(reportRangeSchema, 'query'), asyncHandler(ctrl.myReport))
...
router.post('/team/assign', requirePolicy('counsellor_team', 'write'), validate(assignManagerSchema), asyncHandler(ctrl.assignManager))

// ---- Tasks ----
router.get('/tasks', requirePolicy('counsellor_task', 'read'), validate(taskListQuerySchema, 'query'), asyncHandler(ctrl.listTasks))
router.post('/tasks', requirePolicy('counsellor_task', 'write'), validate(createTaskSchema), asyncHandler(ctrl.createTask))
router.patch('/tasks/:id', requirePolicy('counsellor_task', 'write'), validate(updateTaskSchema), asyncHandler(ctrl.updateTask))
