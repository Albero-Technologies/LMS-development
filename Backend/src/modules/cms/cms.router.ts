...
router.post('/collections', requireRole(Role.ADMIN, Role.SUPER_ADMIN), validate(collectionCreateSchema), asyncHandler(ctrl.createCollection))
router.get('/collections/:id', requireRole(Role.ADMIN, Role.SUPER_ADMIN), asyncHandler(ctrl.getCollection))
router.patch('/collections/:id', requireRole(Role.ADMIN, Role.SUPER_ADMIN), validate(collectionUpdateSchema), asyncHandler(ctrl.updateCollection))
...
router.post('/collections/:id/items', requireRole(Role.ADMIN, Role.SUPER_ADMIN), validate(itemCreateSchema), asyncHandler(ctrl.createItem))
router.get('/collections/:id/items/:itemId', requireRole(Role.ADMIN, Role.SUPER_ADMIN), asyncHandler(ctrl.getItem))
router.patch('/collections/:id/items/:itemId', requireRole(Role.ADMIN, Role.SUPER_ADMIN), validate(itemUpdateSchema), asyncHandler(ctrl.updateItem))
