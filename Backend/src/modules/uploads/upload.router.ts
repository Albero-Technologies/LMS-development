...
router.post('/avatars', withMulter(upload({ kind: 'avatars', mime: 'image', maxBytes: 2 * 1024 * 1024 })), asyncHandler(uploadSingle))
...
router.post('/branding', withMulter(upload({ kind: 'branding', mime: 'image', maxBytes: 2 * 1024 * 1024 })), asyncHandler(uploadSingle))
